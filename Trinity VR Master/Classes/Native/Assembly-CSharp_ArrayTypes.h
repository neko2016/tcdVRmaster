...
#include "AssemblyU2DCSharp_CurvedUI_CurvedUIVertexEffect1126288310.h"
...
#pragma once
// CurvedUI.CurvedUIVertexEffect[]
struct CurvedUIVertexEffectU5BU5D_t2827907251  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) CurvedUIVertexEffect_t1126288310 * m_Items[1];

public:
	inline CurvedUIVertexEffect_t1126288310 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline CurvedUIVertexEffect_t1126288310 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, CurvedUIVertexEffect_t1126288310 * value)
	{
		m_Items[index] = value;
