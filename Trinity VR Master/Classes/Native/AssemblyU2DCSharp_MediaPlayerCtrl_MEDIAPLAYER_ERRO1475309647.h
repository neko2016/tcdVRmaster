...
struct  MEDIAPLAYER_ERROR_t1475309647 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MEDIAPLAYER_ERROR_t1475309647, ___value___1)); }
